...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header">
		...
		<div class="entry-meta">
			...
			<span class="comments-link"><?php comments_popup_link( __( 'Leave a comment', 'vinyl' ), __( '1 Comment', 'vinyl' ), __( '% Comments', 'vinyl' ) ); ?></span>
			<?php endif; ?>
		</div><!-- .entry-meta -->
		<?php endif; ?>
	...
	<?php if ( get_theme_mod( 'vinyl_excerpt' ) == 'yes' ) : ?>
	<div class="entry-summary">
		<?php the_excerpt(); ?>
	</div><!-- .entry-summary -->
	<?php else : ?>
	<div class="entry-content">
		<?php the_content( __( 'Read more', 'vinyl' ) ); ?>
		<?php
			wp_link_pages( array(
